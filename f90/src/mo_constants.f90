...
!  Written Jan 2011, Matthias Cuntz - Ported C-Code
  ...
  CHARACTER(len=*), PARAMETER :: namelist_file = 'canveg-Nass_.nml'!'canveg-calibration.nml'! 1321600 1452000!'canveg-2016.nml'!'canveg.nml'!'canveg-Copy.nml' ! namelist file name
