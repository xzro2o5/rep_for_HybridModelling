...
!  Written Jan 2011, Matthias Cuntz - Ported C-Code
  ...
  CHARACTER(len=*), PARAMETER :: namelist_file = 'canveg-long.nml'!'canveg-calibration.nml'! 1321600 1452000!'canveg-2016.nml'!'canveg.nml'!'canveg-Copy.nml' ! namelist file name
...
!  INTEGER(i4), PARAMETER :: nbetamax_w = 14     ! max # of levels for beta distribution wai Yuan 2018.04.25
  ...
  INTEGER, PARAMETER :: noutoxy        = 124 ! fptr23  oxygen profile flux out
  INTEGER, PARAMETER :: noutdebug      = 125 ! fptr23  debugfile Yuan 2018.09.14
